...
export default function SettingsPage() {
  ...
  return (
    <div style={styles.page}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.cardBody}>
              ...
              <p style={styles.cardDesc}>
                Export complet al tuturor datelor asociate contului tău (Art. 20 GDPR — Dreptul la
                portabilitate).
              </p>
            </div>
            <a
          ...
          <div style={styles.card}>
            ...
            <div style={styles.cardBody}>
              ...
              <p style={styles.cardDesc}>
                Contul și datele tale vor fi șterse permanent (Art. 17 GDPR — Dreptul la ștergere).
      ...
      {deleteState === "success" && (
        <div style={styles.successBanner}>Contul tău a fost șters. Vei fi redirecționat...</div>
      )}
        ...
        <div style={styles.overlay}>
          <div style={styles.modal}>
            ...
            <p style={styles.modalDesc}>
              Această acțiune este <strong>ireversibilă</strong>. Toate datele tale vor fi șterse
              sau anonimizate.
            </p>
            <p style={styles.modalDesc}>Recomandăm să descarci datele înainte de a continua.</p>
