        ...
        {!t.isRing && t.type === "bar" && (
          <>
            <path
              ...
              stroke={isSelected ? "#B794F4" : "rgba(72,187,120,0.45)"}
              strokeWidth={bw}
        ...
        {t.type === "prezidiu" && (
          <>
            <rect
              ...
              height={d.th}
              rx="12"
              fill="rgba(201,144,122,0.07)"
              stroke={isDragTarget ? "#C9907A" : isSelected ? "#B794F4" : "rgba(201,144,122,0.4)"}
              strokeWidth={bw}
            ...
            return (
              ...
              >
                <circle
                  ...
                  vectorEffect="non-scaling-stroke"
                  opacity={
                    highlightGuestId && guest.id !== highlightGuestId
                      ? 0.3
                      : highlightGroupId && guest.grup !== highlightGroupId
                        ? 0.3
                        : 1
                  }
                  style={{
