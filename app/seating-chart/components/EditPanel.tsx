          ...
          <>
            ...
            >
              <button
                ...
                onClick={() => setEditSeats((s) => Math.max(LIMITS[t.type].min, s - 1))}
              >
                −
              </button>
              <span
              ...
              <button
                ...
                onClick={() => setEditSeats((s) => Math.min(LIMITS[t.type].max, s + 1))}
              >
                +
              </button>
              <span style={{ marginLeft: "auto", fontSize: "0.6rem", color: "#6E7490" }}>
                {LIMITS[t.type].min}–{LIMITS[t.type].max}
              </span>
            </div>
          </>
        )}
