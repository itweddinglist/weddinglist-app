...
import {
  clampCam, camReducer, getInitialCam,
  ZOOM_MIN, ZOOM_MAX, ZOOM_DEFAULT, PAN_PAD,
} from './camera.js'
...
describe('camReducer — CAM_SET', () => {
  it('setează vx, vy, z exact', () => {
    ...
    const r = camReducer(state, {
      type: 'CAM_SET', vx: 2000, vy: 2000, z: 1.5,
  ...
  it('aplică clamp pe vx', () => {
    const state = { vx: 0, vy: 0, z: 1 }
    const r = camReducer(state, {
      type: 'CAM_SET', vx: 99999, vy: 0, z: 1,
      canvasW: 1200, canvasH: 700,
    })
...
describe('camReducer — CAM_PAN_BY', () => {
  it('adaugă dxWorld și dyWorld la poziția curentă', () => {
    ...
    const r = camReducer(state, {
      type: 'CAM_PAN_BY', dxWorld: 100, dyWorld: 200,
      canvasW: 1200, canvasH: 700,
    })
  ...
  it('aplică clamp după pan', () => {
    const state = { vx: 0, vy: 0, z: 1 }
    const r = camReducer(state, {
      type: 'CAM_PAN_BY', dxWorld: -99999, dyWorld: 0,
      canvasW: 1200, canvasH: 700,
    })
    expect(r.vx).toBe(-PAN_PAD)
  })
...
describe('camReducer — CAM_ZOOM_AT_NORM', () => {
  ...
  it('z clampat la ZOOM_MAX', () => {
    ...
    const r = camReducer(s, {
      type: 'CAM_ZOOM_AT_NORM', nx: 0.5, ny: 0.5, factor: 999,
      canvasW: 1200, canvasH: 700,
    })
  ...
  it('z clampat la ZOOM_MIN', () => {
    ...
    const r = camReducer(s, {
      type: 'CAM_ZOOM_AT_NORM', nx: 0.5, ny: 0.5, factor: 0.0001,
      canvasW: 1200, canvasH: 700,
    })
