      ...
      <div style={styles.page}>
        <div style={styles.emptyState}>
          ...
          <p style={styles.emptyText}>
            Sesiune inactivă. Autentifică-te prin WordPress pentru a accesa RSVP.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div style={styles.page}>
      ...
      {actionError && (
        ...
        >
          <p style={{ margin: 0, fontSize: "0.85rem", color: "var(--color-danger)" }}>
            {actionError}
          </p>
          <button
      ...
      <div style={styles.actionBar}>
        <button
          ...
          style={{
            ...styles.primaryBtn,
            ...(bulkProgress !== null ? { opacity: 0.7, cursor: "not-allowed" } : {}),
          }}
        >
          {bulkProgress !== null
      ...
      <div style={styles.table}>
        {filtered.map((g) => (
          <GuestRow
            ...
            onToggleManual={() =>
              setManualOverride(manualOverride === g.guest_event_id ? null : g.guest_event_id)
            }
          />
        ))}
      </div>
      ...
      {regenConfirmGuestId && (
        <div style={styles.dialogOverlay}>
          <div style={styles.dialog}>
            <p style={styles.dialogText}>Link-ul anterior va deveni invalid. Continui?</p>
            <div style={styles.dialogActions}>
              ...
              <button onClick={() => setRegenConfirmGuestId(null)} style={styles.dialogCancelBtn}>
                Anulează
              </button>
            </div>
          </div>
...
function RsvpStatsGrid({ stats }: { stats: RsvpStats }) {
  return (
    <div style={styles.statsGrid}>
      ...
      />
      <StatCard
        label="Deschis, fără răspuns"
        value={stats.opened_not_answered}
...
function GuestRow({
  ...
  return (
    <div style={styles.row}>
      ...
      <div style={{ flex: 1 }}>
        <p style={styles.date}>
          {guest.responded_at ? new Date(guest.responded_at).toLocaleDateString("ro-RO") : "—"}
        </p>
      </div>
      ...
      <div style={{ flex: 2, display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
        ...
        {hasInvitation && (
          <>
            ...
            <button onClick={onRegenerate} disabled={isRegenerating} style={styles.regenBtn}>
