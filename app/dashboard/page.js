    ...
    <div>
      ...
      <div style={{ marginBottom: '2rem' }}>
        <div style={{
          ...
          letterSpacing: '0.15em', color: 'var(--rose)', marginBottom: '0.3rem'
        }}>
          Bun venit
        </div>
        <h1 style={{
          fontFamily: 'var(--font-display)',
          fontSize: '2.2rem', fontWeight: 300, color: 'var(--navy)'
        }}>
      ...
      <div style={{
        ...
        {[
          ...
          <div key={i} style={{
            ...
            <div style={{
              fontFamily: 'var(--font-display)',
              fontSize: '2rem', fontWeight: 300, color: 'var(--navy)', lineHeight: 1
            }}>
              {s.value}
            </div>
          ...
          <Link key={m.id} href={m.path} style={{ textDecoration: 'none' }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', marginBottom: '0.6rem' }}>
                ...
                <div style={{
                  fontFamily: 'var(--font-display)',
                  fontSize: '1.1rem', fontWeight: 400, color: 'var(--navy)'
                }}>
                  {m.label}
                </div>
              </div>
              <div style={{ fontSize: '0.78rem', color: 'var(--muted)', marginBottom: '0.8rem', lineHeight: 1.4 }}>
                {m.description}
              </div>
              <div style={{ fontSize: '0.68rem', color: m.color, fontWeight: 500 }}>
                {m.stat}
              </div>
              {m.progress > 0 && (
                <div style={{ marginTop: '0.6rem', height: '3px', background: '#F0EAE0', borderRadius: '2px' }}>
                  <div style={{ width: `${m.progress}%`, height: '100%', background: m.color, borderRadius: '2px' }} />
                </div>
              )}
            </div>
          </Link>
